...
(function ($) {
            ...
            if ($elm.is('option')) {
                ...
                html.push(
					'<li' + (multiple ? ' class="multiple"' : '') + '>',
						'<label id="lbl' + value + '"' + (disabled ? ' class="disabled"' : '') + '>',
							'<input type="checkbox" style="margin-left:25px" name="selectItem" value="' + value + '"' +
    ...
    $.fn.multipleSelect.defaults = {
        isopen: false,
        placeholder: 'Specific Question Selection',
        //selectAll: true,
